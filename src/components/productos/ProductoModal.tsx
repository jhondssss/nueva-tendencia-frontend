...
const schema = z.object({
    ...
    precio_venta:       z.coerce.number({ error: 'Ingresá un monto válido' }).positive('Debe ser mayor a 0'),
    costo_unidad:       z.coerce.number({ error: 'Ingresá un monto válido' }).positive('Debe ser mayor a 0'),
